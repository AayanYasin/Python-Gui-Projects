...
def DisableButtonp1():
    root_snake1.config(state=DISABLED)
    root_gun2.config(state=DISABLED)
    root_water3.config(state=DISABLED)
    root_snake4.config(state=NORMAL)
    root_gun5.config(state=NORMAL)
    root_water6.config(state=NORMAL)


def DisableButtonp2():
    root_snake4.config(state=DISABLED)
    root_gun5.config(state=DISABLED)
    root_water6.config(state=DISABLED)
    root_snake1.config(state=NORMAL)
    root_gun2.config(state=NORMAL)
    root_water3.config(state=NORMAL)
...
def CalculateResult():
    ...
    elif ButtonClickedp1 == "snake" and ButtonClickedp2 == "water" or ButtonClickedp1 == "water" and ButtonClickedp2 == "gun" or ButtonClickedp1 == "gun" and ButtonClickedp2 == "snake":
        root_Winner1.config(text=User_Name1)
        root_Winner1.config(fg="green")
        RPS1 += 1
        root_Score_Player1_Num.config(text=RPS1)
    elif ButtonClickedp2 == "snake" and ButtonClickedp1 == "water" or ButtonClickedp2 == "water" and ButtonClickedp1 == "gun" or ButtonClickedp2 == "gun" and ButtonClickedp1 == "snake":
        root_Winner1.config(text=User_Name2)
        root_Winner1.config(fg="green")
        RPS2 += 1
...
def restart():
    os.startfile(
        r"C:\Users\Yasin\Documents\Aayan\Aayan Programming Projects\Python Gui Games\gui16_SWG_PvsP.py")
    root.destroy()
...
root_Heading = Label(root, text="Snake, Water, Gun Game",
...
root_snake1 = Button(root, text="Snake", bg="pink", width=6, command=click1)
root_gun2 = Button(root, text="Gun", bg="yellow", width=6, command=click2)
root_water3 = Button(root, text="Water", bg="silver", width=6, command=click3)

root_snake4 = Button(root, text="Snake", bg="pink",
                     state=DISABLED, width=6, command=click4)
root_gun5 = Button(root, text="Gun", bg="yellow",
                   state=DISABLED, width=6, command=click5)
root_water6 = Button(root, text="Water", bg="silver",
                     state=DISABLED, width=6, command=click6)
...
root_snake1.grid(row=8, column=0)
root_snake4.grid(row=8, column=1)
root_gun2.grid(row=9, column=0)
root_gun5.grid(row=9, column=1)
root_water3.grid(row=10, column=0)
root_water6.grid(row=10, column=1)
